...
export const PORTAL_APPS: AppItem[] = [ 
  // Slide 1
  { id: '1', name: 'Timesquare', href: 'https://timesquare-federated-social-network-685872424840.us-west1.run.app', img: 'https://github.com/nasmusic-ai/RAW/blob/main/timesquare.png?raw=true' },
...
export const NAV_LINKS: NavLink[] = [
  { label: 'Earthquake Login', href: '#', icon: '🚨' },
  { label: 'Games', href: '#', icon: '🎮' },
  { label: 'Advertising', href: '#', icon: '📢' },
